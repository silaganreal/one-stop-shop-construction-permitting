  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-md-12">
            <form action="includes/editAttachment.php" method="post" enctype="multipart/form-data">
              ...
              <input type="hidden" name="fileApplication" value="<?php echo $applicationID; ?>">
              <input type="hidden" name="fileUser" value="<?php echo $userID; ?>">
