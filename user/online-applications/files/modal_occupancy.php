<div class="modal fade" id="OccupancyPermit" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Apply Online for Occupancy Permit</h5>
        <button type="button" class="btn btn-sm btn-secondary" data-bs-dismiss="modal" aria-label="Close">X</button>
      </div>
      <div class="modal-body">
        <div class="row">
          <div class="col-md-12">
            <form action="./files/action_occupancy.php" method="post" enctype="multipart/form-data">
              <div class="row">
                <!-- start 1st columm -->
                <div class="col-md-6">
              ...
              <input type="hidden" name="appID2" value="<?php echo $applicationID; ?>">
              <input type="hidden" name="applicationType2" value="OCCUPANCY_PERMIT">
              <div class="row">
                <div class="col-md-6">
                   <button type="submit" name="submitApplication2" class="btn btn-sm btn-success">Submit</button>
                </div>
              </div>
            </form>
          </div>
