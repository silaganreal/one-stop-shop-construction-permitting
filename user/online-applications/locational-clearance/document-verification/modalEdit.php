          ...
          <div class="col-md-12">
            <form action="editAttachment.php" method="post" enctype="multipart/form-data">
              <div class="form-group mt-4">
                <button class="btn btn-sm btn-success" type="button" onclick="document.getElementById('newAttachment<?php echo $fileID; ?>').click()">
                  Select File &nbsp;<i class="fas fa-arrow-circle-up"></i>
                </button>
                <input type="file" name="newAttachment" id="newAttachment<?php echo $fileID; ?>" style="display:none;" required>
              ...
              <input type="hidden" name="fileSlug" value="<?php echo $slug; ?>">
