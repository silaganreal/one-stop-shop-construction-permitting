                  ...
                  <table class="table table-hovered">
                    <thead>
                      <tr>
                        ...
                        <!-- <th class="text-secondary text-uppercase text-xxs font-weight-bolder opacity-7">Initial</th> -->
                        ...
                        while($row = mysqli_fetch_assoc($res)) {
                          ...
                          <tr>
                            ...
                            <!-- <td class="text-center text-sm align-middle" >
                              <p class="text-xs font-weight-bold mb-1 mt-1"><?php //echo $row['initial']; ?></p>
                            </td> -->
                            <td class="text-center text-sm align-middle" >
                              <span class="text-xs font-weight-bold"><?php echo $row['status']; ?></span>
