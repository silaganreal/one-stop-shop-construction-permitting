            ...
            <div class="float-end">
              ...
              while($row2 = mysqli_fetch_assoc($res2)) {
                ...
                if($row2['isCurrentArea'] == 'Y' && $row2['isFinished'] == 'N') {
                  ?><button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#updateStage<?php echo $id; ?>">Next Step</button><?php
                  ...
                  <table class="table table-hovered">
                    ...
                    while($row3 = mysqli_fetch_assoc($res3)) {
                      ...
                      <tr>
                          ...
                          <td class="text-dark comment-link">
                          ...
                          <td class="float-end">
                            <a href="verify.php?id=<?php echo $row3['id']; ?>&app=<?php echo $row3['applicationID']; ?>&appID=<?php echo $appID; ?>" class="text-info" onclick="return confirm('Confirm Verification?')">
                              <b>Verify</b>
                            </a>/
                            <a href="#" class="text-danger" data-bs-toggle="modal" data-bs-target="#deny<?php echo $fileID; ?>">
                              <b>Deny</b>
                            </a>
                          </td>
                      </tr>
