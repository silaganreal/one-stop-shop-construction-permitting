...
if( isset($_GET['application']) && isset($_GET['user']) && isset($_GET['appID']) ) {
  ...
  $userID = $_GET['user'];
  $appID = $_GET['appID'];
  $currentArea = 'Assessment Releasing';
  $dateNow = date('Y-m-d');
...
<body class="g-sidenav-show bg-gray-200">
  ...
  $active_assessmentReleasing = "bg-gradient-info";
  $link_assessmentReleasing = "#";
      ...
      <div class="card card-body mx-3 mx-md-4 mt-n6">
        <div class="row mb-2">
          ...
          <div class="col-auto" style="padding-left:50px;">
            <div class="h-100">
              <h3>Assessment Releasing Area</h3>
            </div>
          </div>
          <div class="col">
            <div class="float-end">
              <a href="../building-permit" class="btn btn-sm btn-warning">Back</a>
            </div>
          </div>
        </div>
        <div class="row">
