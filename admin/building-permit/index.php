...
<body class="g-sidenav-show  bg-gray-200">
    ...
    <div class="container-fluid py-4">
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="card my-4 mb-5" style="height:30%vh;">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-info shadow-info border-radius-lg pt-4 pb-1">
                <div class="col-md-12 row">
                  ...
                  <div class="col">
                    <h4 class="float-end text-capitalize ps-3" style="color:#00e64d;">On-Going</h4>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0 display tblBldgPermit" style="width:100%;">
                  <thead>
                    <tr>
                  ...
                  <tbody>
                    <?php
                    $sql = "SELECT a.id, a.userID, a.userappID, a.applicationType, a.applicationDate, a.applicationTime, a.currentArea, a.applicationStatus, a.applicationRemarks, a.applicationDateOut, b.ownerApplicant, b.applicantName, b.projectTitle, b.contactNo, b.emailAdd FROM onlineapplications AS a LEFT JOIN userapplications AS b ON a.userappID = b.id WHERE a.applicationType = 'BUILDING_PERMIT'";
                          ...
                          <div class="d-flex">
                            <div class="d-flex flex-column justify-content-center">
                              <a href="receiving.php?application=<?php echo $id; ?>&user=<?php echo $LoggedUserID; ?>&appID=<?php echo $appID; ?>">
                                <h6 class="mb-0 text-sm text-warning"><?php echo $row['applicantName']; ?></h6>
          ...
          <div class="card my-4" style="height:30%vh;">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-info shadow-info border-radius-lg pt-4 pb-1">
                <div class="col-md-12 row">
                  <div class="col-auto">
                  ...
                  <div class="col">
                    <h4 class="float-end text-capitalize ps-3" style="color:#990000;">Released</h4>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0 display tblBldgPermit" style="width:100%;">
                  ...
                  <tbody>
                    <?php
                    $sql = "SELECT a.id, a.userID, a.userappID, a.applicationType, a.applicationDate, a.applicationTime, a.currentArea, a.applicationStatus, a.applicationRemarks, a.applicationDateOut, b.ownerApplicant, b.applicantName, b.projectTitle, b.contactNo, b.emailAdd FROM onlineapplications AS a LEFT JOIN userapplications AS b ON a.userappID = b.id WHERE a.applicationType = 'BUILDING_PERMIT' AND a.applicationRemarks = 'Permit handed to client'";
                    $res = mysqli_query($conn, $sql);
                    while($row = mysqli_fetch_assoc($res)) {
                      $id = $row['id'];
                      $appID = $row['userappID'];
  ...
  <script type="text/javascript">
    ...
    //search
    var input = document.getElementById("taxDeclaration");
    input.addEventListener("keypress", function(event) {
      if (event.key === "Enter") {
        event.preventDefault();
        document.getElementById("btnSearchTDN").click();
      }
    });
  ...
  <script type="text/javascript">
    // new DataTable('.tblBldgPermit');
    $('.tblBldgPermit').dataTable( {
      "pageLength": 5
    });
  </script>
