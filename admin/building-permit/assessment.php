        ...
        <div class="row mb-2">
          ...
          <div class="col">
            <div class="float-end">
              ...
              <?php
              if($LoggedUserLevel == '1' && $LoggedOwner == '0') {
              ...
              <div class="card-body p-3">
                        ...
                        while($row2 = mysqli_fetch_assoc($res2)) {
                          ...
                          <tr>
                            <td class="align-middle text-sm" style="padding-left:20px;width:150px;">
                              ...
                              if($LoggedUserLevel == '1' && $LoggedOwner == '0') {
                                ?>
                                <a href="#"class="font-weight-bold mb-1 mt-1"data-bs-toggle="modal"data-bs-target="#editSurcharge<?php echo $id; ?>">
                                  <span class="text-warning"><?php echo $row2['assessedFees']; ?></span> (<?php echo $percent; ?>)
                                </a>
                                <?php
                              } else {
                                ?>
                          ...
                          <?php
                          include 'modalUpdateSurcharge.php';
                        }
                      }
                        ...
                        while($row3 = mysqli_fetch_assoc($res3)) {
                          ...
                          <tr>
                            <td class="align-middle text-sm" style="padding-left:20px;width:150px;">
                              ...
                              if($LoggedUserLevel == '1' && $LoggedOwner == '0') {
                                ?>
                                <a href="#"class="font-weight-bold mb-1 mt-1"data-bs-toggle="modal"data-bs-target="#editPenalties<?php echo $id; ?>">
                                  <span class="text-warning"><?php echo $row3['assessedFees']; ?></span>
                                </a>
                                <?php
                              } else {
                                ?>
                          ...
                          <?php
                          include 'modalUpdatePenalties.php';
                        }
                      }
                ...
                if($numLaborCost > 0) {
                  ...
                  while($rowLaborCost = mysqli_fetch_assoc($resLaborCost)) {
                    ...
                    if($LoggedUserLevel == '1' && $LoggedOwner == '0') {
                      ?>
                      <dt class="col-sm-4 text-warning txt-dl"style="font-size:14px;"data-bs-toggle="modal"data-bs-target="#editLaborCost<?php echo $id; ?>">
                        <?php echo $assessedFees; ?>
                      </dt>
                      <?php
                    } else {
                      ?>
                      <dt class="col-sm-4 text-warning txt-dl" style="font-size:14px;">
                        <?php echo $assessedFees; ?>
                      </dt>
                      <?php
                    }
                ...
                <div class="float-start mt-5">
                  <a href="download.php?application=<?php echo $applicationID; ?>&userAppID=<?php echo $appID ?>" class="btn btn-sm btn-success">
                    Download Assessment
                  </a>
                </div>
              </div>
