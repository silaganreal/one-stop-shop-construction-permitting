      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="row">
              <div class="col-md-12">
                <form action="./files/addNewApplication.php" method="post" enctype="multipart/form-data" id="formSearchTDN">
                   <div class="row">
                      <div class="col-md-8">
                      ...
                      <div class="col-auto">
                        <button type="button" class="btn btn-sm btn-primary mt-1" onclick="searchTDN()">Search TDN</button>
                      </div>
                   </div>
                </form>
              </div>
