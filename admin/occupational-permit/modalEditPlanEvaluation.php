                ...
                <form action="updatePlanEvaluation.php" method="post" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <label>Amount <span style="color:red;"><i>*enter amount if status is release</i></span></label>
                      <div class="input-group input-group-outline mb-4">
                        <input type="number" name="peAmount" class="form-control" placeholder="Enter Amount">
                      </div>
                    </div>
                  </div>
                  ...
                  <input type="hidden" name="tpeIncharge" value="<?php echo $row['incharge']; ?>">
                  <div class="row">
                    <div class="col-md-6">
